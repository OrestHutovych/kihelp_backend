...
public class WalletController {
    ...
    public List<WalletResponseDto> getWalletsByUserTelegramId(@PathVariable("telegram_id") String telegramId) {
        return walletGetUseCase.getWalletsByUserTelegramId(telegramId);
    }
